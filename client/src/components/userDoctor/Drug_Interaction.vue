    ...
    <md-app md-mode="fixed">
      <md-app-toolbar class="md-primary" md-elevation="0" style="background-color:#78A5A3;">
        ...
        <div class="md-toolbar-section-end">
          <md-button @click="toDoctorInfo()" style="background-color: #b6d6d4; " v-if="(Window_Width>600)">
            <h6 style="color:black">Doctor Information</h6>
          </md-button>
      ...
      <md-app-drawer md-permanent="card" :md-active.sync="menuVisible" class="menu_color">
        ...
        <md-list class="delete_margin">
          ...
          <md-list-item to="/doctor_drug_interaction" class="selected">
            <md-icon style="margin-right:10px;color:white;">bubble_chart</md-icon>
            <span class="md-list-item-text unselected_text" style="color:white;">Drug Interaction</span>
          </md-list-item>
        </md-list>
