              ...
              <md-card class="md-layout-item">
                <md-card-header>
                  <!--div class="autocomplete" style="width:300px;">
                    <input id="myInput" type="text" name="myCountry" placeholder="Country" @focus="autoCompleteStart" >
                  </div-->
                ...
                <md-card-content style="padding-bottom:0px;">
                  ...
                  <form novalidate @submit.prevent="addDrugToList">
                    ...
                    <!--md-field md-clearable class="autocomplete">      
                      <md-input id="myInput" @focus="autoCompleteStart" v-model="newDrugs.GPName" placeholder="Enter Text"></md-input>
                    </md-field-->
