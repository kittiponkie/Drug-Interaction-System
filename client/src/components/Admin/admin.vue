                    ...
                    <md-table v-model="searched" md-sort="name" md-sort-order="asc" md-card>
                      ...
                      <md-table-row slot="md-table-row" slot-scope="{ item }">
                        ...
                        <md-table-cell md-label="">
                          ...
                          <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#basicExampleModal">Delete
                            Account</button>
                          ...
                          <button type="button" class="close" aria-label="Close" style="border-top-width: 0px,font:10px;"><span
                              aria-hidden="true">&times;</span></button>
                          <button type="button" class="btn btn" style="border-top-width: 0px;">Add Relation</button>
                    ...
                    <md-table v-model="searched" md-sort="name" md-sort-order="asc" md-card>
                      ...
                      <md-table-row slot="md-table-row" slot-scope="{ item }">
                        ...
                        <md-table-cell md-label="">
                          ...
                          <!-- Button trigger modal -->
                          <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#basicExampleModal2">Delete
                            Account</button>
                          <button type="button" class="btn btn" style="border-top-width: 0px;">Add Relation</button>
                    ...
                    <md-table v-model="searched" md-sort="name" md-sort-order="asc" md-card>
                      ...
                      <md-table-row slot="md-table-row" slot-scope="{ item }">
                        ...
                        <md-table-cell md-label="">
                          ...
                          <!-- Button trigger modal -->
                          <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#basicExampleModal3">Delete
                            Account</button>
                    ...
                    <md-table v-model="searched" md-sort="name" md-sort-order="asc" md-card>
                      ...
                      <md-table-row slot="md-table-row" slot-scope="{ item }">
                        ...
                        <md-table-cell md-label="">
                          ...
                          <!-- Button trigger modal -->
                          <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#basicExampleModal4">Delete
                            Account</button>
