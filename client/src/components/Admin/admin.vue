      ...
      <md-app-drawer md-permanent="card" :md-active.sync="menuVisible" class="menu_color">
        ...
        <md-list class="delete_margin">
          <md-list-item to="/admin" class="selected">
            ...
            <span class="md-list-item-text unselected_text" style="color:white;">การจัดการบัญชีผู้ใช้</span>
          </md-list-item>
          <md-list-item to="/admin_request" class="unselected">
            <md-icon style="margin-right:10px;color:black;">account_circle</md-icon>
            <span class="md-list-item-text unselected_text" style="color:black;">คำร้องขอเข้าใช้ระบบของแพทย์</span>
          </md-list-item>
